...
int IalService::buildInputStreamlet(const string & inputUrl,
                                        const DavStreamletSetting::InputStreamletSetting & inputSetting) {
...
int IalService::buildMixStreamlet(const string & mixStreamletName) {
    DavStreamletOption so;
...
int IalService::buildOutputStreamlet(const string & outputId,
